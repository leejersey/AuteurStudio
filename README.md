...
│  │  /api/workflow │──▶│  CardVideo             │  │
│  │  /api/render  │   │  AlgoVideo              │  │
│  │  /api/tts     │   │  KnowledgeVideo         │  │
│  │               │   │  MarkdownVideo          │  │
│  └──────┬───────┘   └────────┬────────────────┘  │
│         │                    │ Template Registry  │
└─────────┼────────────────────┼────────────────────┘
...
| **字体** | Inter + Space Grotesk + Material Symbols | — |
...
│   │   │   └── landscape-video.ts  #   知识讲解 Prompt
│   │   └── types/                  # TypeScript 类型定义
│   │       ├── card-video.ts       #   CardVideoData
│   │       ├── algo-video.ts       #   AlgoVideoData
│   │       ├── knowledge-video.ts  #   KnowledgeVideoData
...
| NarrationSubtitle | `remotion/algo/NarrationSubtitle.tsx` | 旁白字幕，支持 TTS 时间戳逐词同步 |
...
| `/api/render` | POST | 服务端视频渲染 (Remotion → MP4) |
| `/api/projects` | GET/DELETE | 项目列表查询与删除 |
